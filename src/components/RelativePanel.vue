...
import { alignment, applyRelativeChildren, cssLength, useLayoutObserver, xamlThickness } from './layout'
...
useLayoutObserver(root, () => { if (root.value) applyRelativeChildren(root.value) })
</script>
